...
function SchoolItem() {
  return (
    <>
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12 bg-indigo-400">
          <div class="mx-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-6xl dark:text-white">
              Md Abdur Rouf.
            </h1>

            <h1 class="max-w-xxl mb-4 text-xl font-extrabold tracking-tight leading-none md:text-xl xl:text-3xl dark:text-white text-gray-700">
          ...
          <div class="hidden lg:mt-0 lg:col-span-5 lg:flex rounded-full  items-center justify-center bg-amber-400">
            <img
